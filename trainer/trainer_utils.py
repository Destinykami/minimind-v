...
def init_vlm_model(vlm_config, from_weight='pretrain_vlm', tokenizer_path='../model', vision_model_path='../model/vision_model/siglip2-base-p16-ve', save_dir='../out', device='cuda', freeze_llm=0):
