...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='ocr2_sft_vlm', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument('--from_weight', default='ocr_sft_vlm', type=str, help="基于哪个权重训练，为none则不基于任何权重训练")
